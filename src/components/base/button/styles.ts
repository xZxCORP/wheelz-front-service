...
export const baseButton = tv({
  base: 'relative inline-flex select-none items-center justify-center whitespace-nowrap text-center align-middle font-semibold outline-none transition-colors focus:outline-none focus:ring-0 focus:ring-offset-0',
  variants: {
    size: {
